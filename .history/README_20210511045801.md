...
GitHub: https://github.com/rdevans87/ThirdPartyAPIs_DayPlanner

Deployed: https://rdevans87.github.io/ThirdPartyAPIs_DayPlanner/

Summary: Daily Planner App to save events for each hour of the work day with color coded time-blocks.
Tools: HTML, CSS, jQuery, API, Bootstrap, Font Awesome, Moment.js
Role: Full Stack Developer  
